<template>
  <nav
    class="bg-white border-gray-200 px-4 lg:px-6 py-1 dark:bg-gray-800 shadow-md md:block hidden"
  >
        ...
        <ul class="flex flex-row mt-0 mr-6 text-sm font-medium">
          ...
          >
            <NuxtLink
              ...
              class="p-2 py-4 hover:text-blue-700 text-gray-600 dark:text-gray-300 hover:border-b-2 border-blue-600 dark:hover:text-white dark:border-blue-500"
              aria-current="page"
              active-class="!text-blue-700 dark:!text-blue-500 border-b-2 border-blue-600 
              dark:border-blue-500"
            >
              <Icon :name="subNavItem.icon" />
              {{ subNavItem.title }}
            </NuxtLink>
          </li>
        </ul>
...
const subNavLinks = ref([
  ...
  { title: "Products", link: "/my/products", icon: "mdi:podcast" },
  {
